...
std::ostream& printBuffer(std::ostream& stream, const std::byte* buffer, size_t len);

// Print a char buffer side by side as hexadecimal values and decoded string.
inline std::ostream& printBuffer(std::ostream& stream, const std::vector<std::byte>& buffer)
{
